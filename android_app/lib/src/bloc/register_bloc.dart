...
class RegisterBloc extends Object with RegisterValidator implements BaseBloc {
  ...
  Stream<String> get fnameStream =>
      _fnameController.stream.transform(fnameValidator);
  Stream<String> get lnameStream =>
      _lnameController.stream.transform(lnameValidator);
  ...
  Stream<String> get confirmPasswordStream => _confirmPasswordController.stream
        ...
        if (0 != _passwordController.value.compareTo(cp)) {
          ...
          _confirmPasswordController.addError("Password did not match!");
        }
      });
  ...
  Stream<bool> get registerCheck => Rx.combineLatest6(
      phoneNumberStream,
      fnameStream,
      lnameStream,
      emailStream,
